...
def diceroll():
    ...
    # This is where we want to take a picture and read the numbers of the dice, return them in json format
    answer = countDice();
    """answer = {
...
def countDice():
    ...
    for contour in contours:
        ...
        if pips > 6 or pips == 0:
            ...
            # The dice are being added to the results here
